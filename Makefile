...
SERVICE_TEST_SRCS=tests/c/service_lifecycle_test.c src/service.c src/mailbox.c \
...
$(SERVICE_TEST): $(SERVICE_TEST_SRCS) src/service.h
	mkdir -p $(BUILD_DIR)
	$(CC) $(CONTRACT_CFLAGS) -D_POSIX_C_SOURCE=200809L $(LUAINC) -Isrc \
...
$(SERVICE_TSAN_TEST): $(SERVICE_TEST_SRCS) src/service.h
	mkdir -p $(BUILD_DIR)
	$(CC) $(TSAN_CFLAGS) -D_POSIX_C_SOURCE=200809L $(LUAINC) -Isrc \
		-o $@ $(SERVICE_TEST_SRCS) $(LIBS)
