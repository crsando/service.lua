...
- [RPC、Coroutine 与调度](rpc-scheduling.md)：REQUEST/RESPONSE/ERROR、session、coroutine 约束和未来增强边界。
...
- [ltask 调度与消息模型研究](ltask-analysis.md)：N:M scheduler、message/receipt、session/coroutine 及当前项目取舍。
